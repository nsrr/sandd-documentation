...
The [original dataset files](:files_path:/original) represent 11 types of data collected during the data collection process are shared. The data types are described below:
